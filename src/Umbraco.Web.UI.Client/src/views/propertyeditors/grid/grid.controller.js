    ...
    function ($scope, $http, assetsService, $rootScope, dialogService, gridService, mediaResource, imageHelper, $timeout, umbRequestHelper) {
        ...
        $scope.sortableOptionsCell = {
            ...
            stop: function (e, ui) {
                ...
                $timeout(function () {
                    // reconstruct the dragged RTE (could be undef when dragging something else than RTE)
        ...
        $scope.percentage = function (spans) {
            return Math.floor((spans / $scope.model.config.items.columns) * 100).toFixed(1);
        };
